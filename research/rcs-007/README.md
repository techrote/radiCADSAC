...
Status: active RCS-007 experiment package  
...
The main interpretation is in `docs/15-VIRTUAL-TOLERANCE-RESEARCH.md`.
...
Use `--profile baseline` for the broader sweep.
...
Generated `.results/` data is CI/runtime evidence and is not committed as hand-authored source.
